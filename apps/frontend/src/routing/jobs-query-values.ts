...
export const canonicalList = <T extends string>(
  params: URLSearchParams,
  name: string,
  order: readonly T[],
): T[] => {
...
export const orderedValues = <T extends string>(values: readonly string[], order: readonly T[]): T[] => {
...
export const parseIntegerInRange = (value: string, minimum: number, maximum: number): number | null => {
