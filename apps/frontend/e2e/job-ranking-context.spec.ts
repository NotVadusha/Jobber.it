...
const installWire = async (page: Page, events: readonly WireStreamEvent[]): Promise<void> => {
...
const openRankedResults = async (page: Page): Promise<void> => {
...
const openRankedJob = async (page: Page): Promise<void> => {
